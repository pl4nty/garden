...
var Footer_default = ((opts) => {
  const Footer = ({ displayClass }) => {
    ...
    return /* @__PURE__ */ u2("footer", { class: `${displayClass ?? ""}`, children: [
      /* @__PURE__ */ u2("hr", {}),
      /* @__PURE__ */ u2("ul", { children: [
        ...Object.entries(links).map(([text, link]) => /* @__PURE__ */ u2("li", { children: /* @__PURE__ */ u2("a", { href: link, children: text }) })),
        /* @__PURE__ */ u2("li", { children: [
          "Cultivated with ",
          /* @__PURE__ */ u2("a", { href: "https://obsidian.md/", children: "Obsidian" }),
          " and ",
