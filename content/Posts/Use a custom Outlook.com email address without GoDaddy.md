...
# 2025 Update
Mail is still flowing, but [Outlook Autodiscover](https://learn.microsoft.com/en-us/exchange/client-developer/exchange-web-services/autodiscover-for-exchange) recently stopped working. A first-party service managed to create an [[Azure AD|Azure AD]] account with my email address, but no way to login, and Outlook thinks it has my mail. Lucky my @outlook.com.au still works.