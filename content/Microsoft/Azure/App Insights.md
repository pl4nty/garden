...
## Ingest
Global ingest endpoints like `dc.applicationinsights.azure.com` were deprecated in 2025, in favour of regional endpoints like `australiaeast-1.in.applicationinsights.azure.com`.
