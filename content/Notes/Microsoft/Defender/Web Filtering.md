...
modified: 2026-04-07
---
[Web content filtering](https://learn.microsoft.com/en-us/defender-endpoint/web-content-filtering) would be a useful security control, if certain admins didn't block the `Uncategorized` category... Lots of cool apps like to use fresh domains. Filtering used data from Cyren, but later moved to NetStar. Both of them have significant categorization issues.
